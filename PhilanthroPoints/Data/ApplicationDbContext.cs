...
public static class Seed
{
    public static void SeedIfEmpty(ApplicationDbContext db)
    {
        ...
        if (!adminUsersExist)
        {
            Console.WriteLine("[SEED] Seeding admin users (separate check)...");
            db.AdminUsers.AddRange(
                new AdminUser
                {
                    Username = "superadmin",
            ...
            Console.WriteLine("[SEED] Calling SaveChanges for AdminUsers...");
            db.SaveChanges();
            Console.WriteLine("[SEED] AdminUsers seeded successfully!");
        }
        else
        {
            Console.WriteLine("[SEED] AdminUsers already exist, skipping AdminUsers seeding.");
        }
